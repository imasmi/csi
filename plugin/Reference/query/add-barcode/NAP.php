...
?>
<form class="form admin" id="form" accept-charset="UTF-8" method="post" action="<?php echo \system\Core::this_path(0,-1);?>/place-NAP?type=<?php echo $_POST["type"];?>" target="_blank">
