<?php 
$file = str_replace(array("\nИзвестие\nПротокол\n", "Дата\nиздаване"), array(" ", "Дата издаване"), $file);
$rows = explode("\n", $file);
$fRow = $rows[0];
$Import->fRow = $fRow;
unset($rows[0]);
...
?>
<div class="admin">
	<form method="post" action="<?php echo $Import->qwdir;?>/invoice" target="_blank">
		<table class="listTable" border="1px" cellpadding="0" cellspacing="0">
			
			<tr><th colspan="100%">Фактури</th></tr>
			<tr>
	...
	<?php 
		++$a;
			...
			<tr><td colspan="8"><input type="submit" class="button" name="importinvoice" value="Запази"/></td></tr>
		</table>
