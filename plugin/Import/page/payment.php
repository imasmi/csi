...
?>
<div class="admin">
	<form method="post" action="<?php echo $Import->qwdir;?>/payments" target="_blank">
		<table class="listTable" border="1px" cellpadding="0" cellspacing="0">
			
			<tr><th colspan="100%">Плащания</th></tr>
			<tr>
	...
	<?php 
		++$a;
			...
			<tr><td colspan="8"><input type="submit" class="button" name="importPayments" value="Запази"/></td></tr>
		</table>
