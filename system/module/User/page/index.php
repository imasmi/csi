...
<form class="form" id="login" action="<?php echo $Core->query_path() . 'login';?>" method="post" onsubmit="return S.post('<?php echo $Core->query_path() . 'login';?>', S.serialize('#login'), '#error-message')">
...
<div class="clear text-center"><a href="<?php echo $Core->this_path(0,-1);?>/forgotten-password"><?php echo $Text->_("Forgotten password");?></a></div>
</div>