<h1>ListingAPP.php</h1>
    ...
    <span>Instance: new \system\module\Listing\php\ListingAPP;</span>
    ...
    <h2>Variables</h2>
        ...
        <h3>ListingAPP->Query</h3>
            <span>A variable with instance of \system\php\Query class.</span>
            
        <h3>ListingAPP->Info</h3>
            <span>A variable with instance of \system\module\Info\php\Info class.</span>
        
        <h3>ListingAPP->Language</h3>
            <span>A variable with instance of \system\module\Language\php\Language class.</span>
            
        <h3>ListingAPP->User</h3>
            <span>A variable with instance of \system\module\User\php\User class.</span>
            
        <h3>ListingAPP->Page</h3>
            <span>A variable with instance of \system\module\Page\php\Page class.</span>
        
        <h3>ListingAPP->Text</h3>
            <span>A variable with instance of \system\module\Text\php\Text class.</span>
        
        <h3>ListingAPP->File</h3>
            <span>A variable with instance of \system\module\File\php\File class.</span>
            
        <h3>ListingAPP->Setting</h3>
            <span>A variable with instance of \system\module\Setting\php\Setting class.</span>
        ...
        <h3>ListingAPP->view</h3>
            ...
            <ul>
                <li>
                    ...
                    <span>value: a value to select with $Query->select function</span>
                    <span>fields (array or *): array with columns to display or * for all columns</span>
                    <span>selector: column to select with $Query->select function</span>
                    <span>table: table to select with $Query->select function</span>
                    <span>delimeter: delimeter to select with $Query->select function</span>
                    <p>Example: $ListingAPP->view(10, array("id", "tag", "path"), "id", $File->table, "=")</p>
                    <span>The example above will use $Query->select function to select row from $File->table with id=10 and will output its id, tag and path values in HTML table.</span>
                </li>
            </ul>
