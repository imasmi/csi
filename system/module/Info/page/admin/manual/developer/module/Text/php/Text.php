<h1>Text.php</h1>
    ...
    <span>Instance: new \system\module\Text\php\Text;</span>
    ...
    <h2>Input parameters</h2>
        ...
        <h3>2. Array</h3>
            ...
            <ul>
                <li>table => string(existing database table): set object related database table. Default is prefix_text received from $this->Query->table("text") function.</li>
            ...
            <p>Example: $Shop_file = new \system\module\File\php\File(42, array("plugin" => "Shop"));</p>
    ...
    <h2>Variables</h2>
        ...
        <h3>Page->Plugin</h3>
            <span>A variable with instance of \system\module\Plugin\php\Plugin class.</span>
