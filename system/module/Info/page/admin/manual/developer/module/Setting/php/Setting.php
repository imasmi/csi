<h1>Setting.php</h1>
    ...
    <span>Instance: new \system\module\Setting\php\Setting;</span>
    ...
    <h2>Input parameters</h2>
        ...
        <h3>2. Array</h3>
            ...
            <ul>
                <li>table => string(existing database table): set object related database table. Default is prefix_setting received from $this->Query->table("setting") function.</li>
            ...
            <p>Example: $Shop_setting = new \system\module\Setting\php\Setting(42, array("plugin" => "Shop"));</p>
