<h1>File.php</h1>
    ...
    <span>Instance: new \system\module\File\php\File;</span>
    ...
    <h2>Input parameters</h2>
        ...
        <h3>Array</h3>
            ...
            <ul>
                <li>table => string(existing database table): set object related database table. Default is prefix_file received from $this->Query->table("file") function.</li>
            ...
            <p>Example: $Shop_text = new \system\module\Text\php\Text(42, array("plugin" => "Shop"));</p>
    ...
    <h2>Variables</h2>
        ...
        <h3>Text->Module</h3>
            <span>A variable with instance of \system\module\Module\php\Module class.</span>
