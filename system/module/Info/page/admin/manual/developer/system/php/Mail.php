    ...
    <h3>Mail->validate</h3>
        ...
        <ul>
            <li>
                ...
                <p>Example: $Mail->validate("test@web.imasmi.com");</p>
                <span>The example above will return test@web.imasmi.com</span>
                <p>Example: $Mail->validate("test@");</p>
    ...
    <h3>Mail->send</h3>
        ...
        <ul>
            <li>
                ...
                <p>Example: $Mail->send("info@imasmi.com", "Hello", "How are you?", array("reply-to" => "test@imasmi.com"));</p>
                ...
                <p>Example: $Mail->send(""info@imasmi.com", "Hello", "How are you?", array("sender" => "ImaSmi Web", "from" => "info@web.imasmi.com"));</p>
