    ...
    <h3>Ini->format</h3>
        ...
        <ul>
            <li>
                ...
                <p>Example: $Ini->format(array("name" => "Peter", "age" => "18"));</p>
                <span>The example above will output: <br/><br/>name = peter <br/> age = 18</span>
                <p>Example: $Ini->format("Person" = array("name" => "Peter", "age" => "18"));</p>
    ...
    <h3>Ini->save</h3>
        ...
        <ul>
            <li>
                ...
                <p>Example: $Ini->save("/web/ini/setup.ini","Person" = array("name" => "Peter", "age" => "18"), FILE_APPEND);</p>
