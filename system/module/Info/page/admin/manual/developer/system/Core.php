<h1>Core.php</h1>
    ...
    <h3>Core->list_dir</h3>
        ...
        <ul>
            <li>
                ...
                <p>Example: $Core->list_dir("/web/file");</p>
    ...
    <h3>Core->path_resolve</h3>
        ...
        <ul>
            <li>
                ...
                <p>Example: $Core->path_resolve("/web/page/home.php");</p>
    ...
    <h3>Core->links</h3>
        ...
        <ul>
            <li>
                <h4>Core->links()</h4>
                <p>Example: print_r($Core->links()) when in URL /home/hello/welcome;</p>
    ...
    <h3>Core->path_slice</h3>
        ...
        <ul>
            <li>
                ...
                <p>Example: $Core->path_slice("/home/hello/welcome", 1, 2);</p>
                <span>Will return /hello/welcome.</span>
                <p>Example: $Core->path_slice("/home/hello/welcome", 1, 1);</p>
    ...
    <h3>Core->this_path</h3>
        ...
        <ul>
            <li>
                ...
                <span>start (optional): if presented will set slice start offset. If start value is non-negative, the sequence will start at that point in the array. If start value is negative, the sequence will start that far from the end of the array. Example: -1</span>
                <span>end (optional): if presented will set slice length end point. If end is presented and is positive, then the slice will have up to that many elements in it. If the array is shorter than the end length, then only the available array elements will be present. If end is given and is negative then the slice will stop that many elements from the end of the array.</span>
                <p>Example: $Core->this_path() in URL /home/hello/welcome;</p>
                <span>Will return /home/hello/welcome.</span>
                <p>Example: $Core->this_path(1, 2) in URL /home/hello/welcome;</p>
                <span>Will return /hello/welcome.</span>
                <p>Example: $Core->this_path(-1) in URL /home/hello/welcome;</p>
    ...
    <h3>Core->query_path</h3>
        ...
        <ul>
            <li>
                ...
                <span>start (optional): if presented will set slice start offset. If start value is non-negative, the sequence will start at that point in the array. If start value is negative, the sequence will start that far from the end of the array. Example: -1</span>
                <span>end (optional): if presented will set slice length end point. If end is presented and is positive, then the slice will have up to that many elements in it. If the array is shorter than the end length, then only the available array elements will be present. If end is given and is negative then the slice will stop that many elements from the end of the array.</span>
                <p>Example: $Core->query_path() in URL /home/hello/welcome;</p>
                <span>Will return /query/home/hello/welcome.</span>
                <p>Example: $Core->query_path(1, 2) in URL /home/hello/welcome;</p>
                <span>Will return /query/hello/welcome.</span>
                <p>Example: $Core->query_path(-1) in URL /home/hello/welcome;</p>
    ...
    <h3>Core->url</h3>
        ...
        <ul>
            <li>
                <h4>Core->url()</h4>
                <p>Example: $Core->query_path() where application is installed in https://web.imasmi.com;</p>
                <span>Will return /</span>
                <p>Example: $Core->query_path() where application is installed in https://web.imasmi.com/application;</p>
    ...
    <h3>Core->doc_root</h3>
        ...
        <ul>
            <li>
                <h4>Core->doc_root()</h4>
                <p>Example: $Core->doc_root() called from any place within the app where application is installed in folder /home/www/public_html;</p>
