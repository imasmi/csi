...
$SettingAPP_select = new \module\Setting\SettingAPP($_GET["id"]);
...
<form class="form" id="form" action="<?php echo \system\Core::query_path();?>?id=<?php echo $_GET["id"];?>" method="post" enctype="multipart/form-data">
    <table class="table">
        <tr>
            <td>Tag</td>
            <td><?php echo \system\Form::select("tag", array("theme" => "Theme") + \system\Query::column_group("tag"), array("select" => $select["tag"], "required" => true, "addon" => true));?></td>
        </tr>
