...
<form class="form" id="form" action="<?php echo $Core->query_path();?>" method="post" enctype="multipart/form-data">
    <table class="table">
        <tr>
            <td>Tag</td>
            <td><?php echo $Form->select("tag", array("theme" => "Theme") + $Query->column_group("tag"), array("select" => "theme", "required" => true, "addon" => true));?></td>
        </tr>
        ...
        <tr>
            ...
            <td><?php echo $Form->select("menu", $Query->column_group("menu"), array("addon" => true, "select" => (isset($_GET["menu"]) ? $_GET["menu"] : false)));?></td>
        </tr>
