<h1>Language.php</h1>
    ...
    <span>Instance: new \module\Language\Language;</span>
    ...
    <h2>Variables</h2>
        ...
        <h3>Language->items</h3>
            <span>Array with all enabled languages in the system from the languages INI file where active=1</span>
        ...
        <h3>Language->items</h3>
            ...
            <ul>
                <li>
                    ...
                    <span>show_all: select even disabled languages with active=0 in INI file. Default is false.</span>
