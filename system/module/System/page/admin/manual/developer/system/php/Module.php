<h1>Module.php</h1>
    ...
    <h3>Module->_</h3>
        ...
        <ul>
            <li>
                <h4>Module->_()</h4>
                <p>Example: print_r(\system\Module::_()) when at url /User/login</p>
                <span>User is system module and the example will output User.</span>
                <p>Example: print_r(\system\Module::_()) when at url /Home/login</p>
                <span>Home is not system module and the example will not print anything to the screen, as \system\Module::_() will return false.</span>
            </li>
        </ul>