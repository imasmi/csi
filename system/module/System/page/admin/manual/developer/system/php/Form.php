    ...
    <h3>Form->validate</h3>
        ...
        <ul>
            <li>
                ...
                <p>Example: \system\Form::validate(array("#name" => "Fill name", "#email" => "Incorrect email address"));</p>
    ...
    <h3>Form->on_off</h3>
        ...
        <ul>
            <li>
                ...
                <p>Example: \system\Form::on_off("switch",1);</p>
    ...
    <h3>Form->select</h3>
        ...
        <ul>
            <li>
                ...
                <p>Example: \system\Form::select("languages",array("en"=>"english", "bg"=>"bulgarian"), array("select"=>"en", "required"=>true, "title"=>"Choose language", "addon"=>"add new language", "onchange"=>"alert('Language is changed')"));</p>
    ...
    <h3>Form->created</h3>
        ...
        <ul>
            <li>
                ...
                <p>Example: \system\Form::created("created",2021-01-13 22:16:59);</p>
