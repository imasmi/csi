...
foreach($PDO->query("SELECT id, path FROM " . \system\Data::table() . " WHERE link_id='" . $_GET["id"] . "'") as $file){
...
\system\Data::cleanup(["query" => "SELECT * FROM " . $File->table . " WHERE id='" . $_GET["id"]  . "'"]);
