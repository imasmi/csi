...
?>
<div class="admin">
<h2 class="text-center title">Add <?php echo $Object->plugin;?> item</h2>
<div class="error-message" id="error-message"></div>
<form class="form" id="form" action="<?php echo \system\Core::query_path();?>" method="post" enctype="multipart/form-data">
    <table class="table">
        <tr>
            <td>Type</td>
            <td><?php echo \system\Form::select("type", \system\Database::column_group("type", $Object->table), array("addon" => true));?></td>
        </tr>
        
        <tr>
            <td>Subpage of</td>
            <td><?php $PageAPP->select("link_id", array("query" => "SELECT id FROM " . $Page->table . " WHERE (plugin='" . $Object->plugin . "' AND tag='" . $Object->tag . "') OR id='" . $Object->link_id . "' ORDER by link_id ASC, " . $Language->_() . " ASC", "select" => $Object->link_id));?></td>
        </tr>
        ...
        <tr>
            ...
            <td><?php echo \system\Form::select("menu", \system\Database::column_group("menu", $Object->table), array("addon" => true));?></td>
        </tr>
    </table>
