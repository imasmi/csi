...
<form class="form" id="form" action="<?php echo \system\Core::query_path();?>" method="post" enctype="multipart/form-data">
    <table class="table">
        <tr>
            <td>Type</td>
            <td><?php echo \system\Form::select("type", \system\Data::column_group("type", $Object->table), array("addon" => true));?></td>
        </tr>
        ...
        <tr>
            ...
            <td><?php echo \system\Form::select("menu", \system\Data::column_group("menu", $Object->table), array("addon" => true));?></td>
        </tr>
    </table>
