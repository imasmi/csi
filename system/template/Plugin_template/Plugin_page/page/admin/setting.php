...
$SettingAPP_select = new system\module\Setting\php\SettingAPP($_GET["id"], array("plugin" => $Object->plugin));
$FileAPP_page = new system\module\File\php\FileAPP($_GET["id"], array("plugin" => $Object->plugin));
?>
<div class="admin">
...
<form class="form" id="form" action="<?php echo $Core->query_path();?>?id=<?php echo $_GET["id"];?>" method="post" enctype="multipart/form-data">
    <table class="table">
        <tr>
            <td>Type</td>
            <td><?php echo $Form->select("type",$Query->column_group("type", $Object->table), array("select" => $select["type"], "addon" => true));?></td>
        </tr>
        ...
        <tr>
            ...
            <td><?php echo $Form->select("menu", $Query->column_group("menu", $Object->table), array("select" => $select["menu"], "addon" => true));?></td>
        </tr>
    </table>
