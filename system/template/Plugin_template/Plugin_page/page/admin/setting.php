...
<form class="form" id="form" action="<?php echo \system\Core::query_path();?>?id=<?php echo $_GET["id"];?>" method="post" enctype="multipart/form-data">
    <table class="table">
        <tr>
            <td>Type</td>
            <td><?php echo \system\Form::select("type",\system\Query::column_group("type", $Object->table), array("select" => $select["type"], "addon" => true));?></td>
        </tr>
        ...
        <tr>
            ...
            <td><?php echo \system\Form::select("menu", \system\Query::column_group("menu", $Object->table), array("select" => $select["menu"], "addon" => true));?></td>
        </tr>
    </table>
