...
if ($Theme->active === false && $User->group("admin") && (\system\Module::_() != "Theme" && \system\Module::_() != "Store")) { ?><script>location.href='<?php echo \system\Core::url();?>Theme/admin/index';</script><?php }
